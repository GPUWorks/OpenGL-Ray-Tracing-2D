...
GLuint Heptagon::generateVBO()
{
	...
	float scale = 0.9f;
	float x_translate = 0.55f;
	float y_translate = 0.40f;

	VertexFormat* heptagon_center = new VertexFormat(glm::vec4(0.0 * scale + x_translate, 0.0 * scale + y_translate, 0.0, 1), glm::vec4(0.2, 0.8, 0.9, 1));
	
	VertexFormat* heptagon_middle_up = new VertexFormat(glm::vec4(0.0 * scale + x_translate, 0.2 * scale + y_translate, 0.0, 1), glm::vec4(0.2, 0.8, 0.9, 1));
	VertexFormat* heptagon_left_up = new VertexFormat(glm::vec4(-0.2 * scale + x_translate, 0.08 * scale + y_translate, 0.0, 1), glm::vec4(0.2, 0.8, 0.9, 1));
	VertexFormat* heptagon_left_down_1 = new VertexFormat(glm::vec4(-0.2 * scale + x_translate, -0.06 * scale + y_translate, 0.0, 1), glm::vec4(0.2, 0.8, 0.9, 1));
	VertexFormat* heptagon_left_down_2 = new VertexFormat(glm::vec4(-0.08 * scale + x_translate, -0.2 * scale + y_translate, 0.0, 1), glm::vec4(0.2, 0.8, 0.9, 1));
	VertexFormat* heptagon_right_down_2 = new VertexFormat(glm::vec4(0.08 * scale + x_translate, -0.2 * scale + y_translate, 0.0, 1), glm::vec4(0.2, 0.8, 0.9, 1));
	VertexFormat* heptagon_right_down_1 = new VertexFormat(glm::vec4(0.2 * scale + x_translate, -0.06 * scale + y_translate, 0.0, 1), glm::vec4(0.2, 0.8, 0.9, 1));
	VertexFormat* heptagon_right_up = new VertexFormat(glm::vec4(0.2 * scale + x_translate, 0.08 * scale + y_translate, 0.0, 1), glm::vec4(0.2, 0.8, 0.9, 1));
...
void Heptagon::bindShaderInputData()
{
