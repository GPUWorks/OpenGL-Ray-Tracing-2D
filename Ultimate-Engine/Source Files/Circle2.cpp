...
GLuint Circle2::generateVBO()
{
	...
	for (int i = 0; i < segments_no; i++)
	{
		...
		VertexFormat* circle_1 = new VertexFormat(glm::vec4(x + translate_x, y + translate_y, 0.0, 1), glm::vec4(0.6, 0.9, 0.1, 1));
		...
		if (i + 1 == 20)
		{
			...
			VertexFormat* circle_2 = new VertexFormat(glm::vec4(x_2 + translate_x, y_2 + translate_y, 0.0, 1), glm::vec4(0.6, 0.9, 0.1, 1));
...
void Circle2::bindShaderInputData()
{
